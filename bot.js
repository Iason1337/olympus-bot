...
client.on("message", async message =>{
  ...
  let args = messageArray.slice(1);
    if(message.channel === message.guild.channels.find("name","player-suggestions") || cmd==="!suggest"){
    if(message.content.includes("suggest")!==true){
      message.delete()
      return message.author.send("This channel is only for suggestions. To suggest something type !suggest <your suggestion> ")
    } if (args===""){
